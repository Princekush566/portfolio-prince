        ...
        <div className="flex items-start gap-3 ">
            {comment.profileImage ? (
                <img
                    ...
                    className="w-10 h-10 rounded-full object-cover border-2 border-lime-500/30"
                    loading="lazy"
                />
            ) : (
                <div className="p-2 rounded-full bg-lime-400/20 text-lime-400 group-hover:bg-lime-400/30 transition-colors">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-lime-500 focus:ring-2 focus:ring-lime-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-lime-500 focus:ring-2 focus:ring-lime-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
                    ...
                    {imagePreview ? (
                        <div className="flex items-center gap-4">
                            <img
                                src={imagePreview}
                                alt="Profile preview"
                                className="w-16 h-16 rounded-full object-cover border-2 border-lime-500/50"
                            />
                            <button
                                type="button"
                                onClick={() => {
                        ...
                        <div className="w-full" >
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-lime-500/20 text-lime-400 hover:bg-lime-500/30 transition-all border border-dashed border-lime-500/50 hover:border-lime-500 group"
                            >
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-lime-400 to-green-600 rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
    ...
    return (
        ...
        <div className="p-6 border-b border-white/10" data-aos="fade-down" data-aos-duration="800">
            <div className="flex items-center gap-3">
                <div className="p-2 rounded-xl bg-lime-400/20">
            ...
            <div className="space-y-4 h-[300px] overflow-y-auto custom-scrollbar" data-aos="fade-up" data-aos-delay="200">
                {comments.length === 0 ? (
                    <div className="text-center py-8" data-aos="fade-in">
                        <UserCircle2 className="w-12 h-12 text-lime-400 mx-auto mb-3 opacity-50" />
