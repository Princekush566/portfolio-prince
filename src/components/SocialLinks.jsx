...
//     subText: "on LinkedIn",
//     icon: Linkedin,
//     url: "www.linkedin.com/in/prince-kushwaha",
//     color: "#0A66C2",
...
//     name: "GitHub",
//     displayName: "Github",
//     subText: "Princekush566",
//     icon: Github,
//     url: "https://github.com/Princekush566",
//     color: "#ffffff",
...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/prince-kushwaha",
    color: "#0A66C2",
    gradient: "from-[#0A66C2] to-[#0077B5]",
    isPrimary: true
  },
  ...
  },
  {
    ...
    subText: "Chat me here.",
    icon: FaWhatsapp,
    url: "https://wa.me/9766709759", // ✅ replace with your number
    color: "#25D366",
...
const SocialLinks = () => {
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3 className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
        <span className="inline-block w-8 h-1 bg-lime-400 rounded-full"></span>
        Connect With Me
      </h3>
